...
const StaticBackground = () => {
  return (
    <div className="fixed overflow-hidden select-none -z-10 h-screen w-screen bg-gray-800">
      <img
        className="h-full w-full opacity-40 object-cover block md:hidden"
        src={background_potrait}
      />
      <img
        className="h-full w-full opacity-40 object-cover hidden md:block"
        src={background_landscape}
      />
    </div>
  );
};
